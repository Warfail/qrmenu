  ...
  return (
    <main className="flex min-h-screen flex-col justify-between overflow-hidden bg-[#0a0a0c]">
      ...
      <section className="relative">
        <div className="relative flex aspect-[1.06/1] min-h-[300px] w-full flex-col justify-end overflow-hidden px-6 pb-4">
          ...
          <div className="relative">
            <h1 className="max-w-full text-[26px] font-extrabold leading-tight text-white">
              ROOFTOP
      ...
      {/* FOOTER */}
      <footer className="flex flex-col items-center pb-2 pt-9">
